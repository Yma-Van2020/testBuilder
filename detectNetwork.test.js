  ...
  // Write full test coverage for the Maestro card
      ...
      for (var i = 0; i < prefixes.length; i++) {
        ...
        for (var len = 12; len <= 19; len++) {
          var rest = '0123456789012345'.slice(0, len - 4);
          (function(prefix) {
    ...
    describe('Switch', function() {
      ...
      for (var i = 0; i <= prefixs.length; i++) {
        ...
        for (var len = 16; len <= 19; len++) {
          var rest = '0123456789012345'.slice(0, len - (prefix.length));
          (function(prefix) {  
            it('has a prefix of ' + prefix + ' and a length of ' + len);  
            detectNetwork(prefix + rest).should.equal('Switch');
          })(prefix);
        }
      }
    });
